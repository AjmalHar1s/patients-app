...
MySQL - 8.0.25 : Database - docondoor
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`docondoor` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
insert  into `bank`(`bank_id`,`login_id`,`bank_name`,`account_no`,`ifsc`,`pin`,`amount`) values 
(1,23,'FEDERAL','11223344','fdrl01','1998',1400);
...
(5,23,19,'2021-04-15','10:14:28','200','pending'),
(6,23,19,'2021-04-15','10:15:16','200','pending'),
(7,23,19,'2021-04-15','10:18:45','200','pending'),
(8,23,19,'2021-04-15','10:31:37','200','pending'),
(9,23,19,'2021-04-15','12:42:08','200','pending'),
(10,23,19,'2021-04-15','12:44:50','200','pending');
...
(1,19,23,'hi','2021-04-08'),
(2,23,19,'hello','2021-04-08'),
(3,23,19,'hii','2021-04-12'),
(4,23,20,'hii','2021-04-12');
...
(3,19,4,23,'dipa','dipa@123.com','md','+97145726400','Female','17028'),
(4,20,4,NULL,'salim','marine@lulu.com','MBBS','+97123456775','radiobutton','653432'),
...
(10,33,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(11,34,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(12,35,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(13,36,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(14,37,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
(1,13,'mala','kannoor','hello@hskhfdo.com','9061180831','435231'),
(23,12,'mims','calicut','mims@gmai.com','98476583647','54763');
...
CREATE TABLE `login` (
  `logid_id` int NOT NULL AUTO_INCREMENT,
...
(32,'diya','123456','doctor'),
(33,'diya','123456','doctor'),
(34,'diya','123456','doctor'),
(35,'sam','12345678','doctor'),
(36,'sam','12345678','doctor'),
(37,'jack','123456','doctor'),
(38,'jose','112233','patient'),
(40,'thanima','thanima','pharmacy');
...
CREATE TABLE `medicine_booking` (
  `medicine_booking_id` int NOT NULL AUTO_INCREMENT,
...
insert  into `medicine_booking`(`medicine_booking_id`,`prescription_id`,`pharmacy_id`,`date`,`status`) values 
(2,1,5,'2021-04-05','pending');
...
(9,38,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
(2,3,NULL,3,'karuna','karuna@gmail.com','9875634213','11.050976','76.071098','malappuram','456321'),
(0,9,14,NULL,'ASQ','SADAS`3434','4545',NULL,NULL,'SSEDF','546'),
(NULL,10,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(NULL,11,40,NULL,'thanima','thanima@der.co','9874562315',NULL,NULL,'moozhikkal','674231');
...
(2,23,3,19,'2times','3 days','2021-04-15','15:50:03'),
(3,23,2,19,'4','4','2021-04-15','16:05:12'),
(4,23,4,19,'4','5','2021-04-15','16:09:15');
...
(3,19,'12:00:00','04:00:00','0000-00-00'),
(4,19,'05:00:00','06:00:00','Saturday');
